...
const blogPosts = [
    ...
    new GenericPostInformation("starting-with-a-bang", "startingWithABang.md", "2021: Starting with a Bang", "1/31/21", "glass-cheers", "A reflection on my January 2021 and some new goals for February."),
];
